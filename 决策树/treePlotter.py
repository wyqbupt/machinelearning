...
font = FontProperties(fname=r"/usr/share/fonts/truetype/wqy/wqy-microhei.tty", size=14)
...
def plotTree(myTree, parentPt, nodeTxt):
    ...
    plotNode(firstStr, cntrPt, parentPt, decisionNode,font)
    secondDict = myTree[firstStr]
    ...
    for key in secondDict.keys():
        if type(secondDict[key]).__name__=='dict':
            ...
            plotNode(secondDict[key], (plotTree.xOff, plotTree.yOff), cntrPt, leafNode,font)
...
lenseTree = trees.createTree(lense,lenseLabels)
